...
$.extend($.validator, {
	...
	messages: {
		...
		creditcard: "Por favor, ingrese un número de Tarjeta de Crédito válida.",
		equalTo: "Por favor, ingrese el mismo valor.",
		accept: "Por favor, introduzca un valor con una extensión válida.",
		maxlength: $.validator.format("Por favor, introduzca menos de {0} caracteres."),
		minlength: $.validator.format("Por favor, introduzca al menos {0} caracteres."),
		rangelength: $.validator.format("Por favor, introduzca un valor entre {0} y {1}."),
